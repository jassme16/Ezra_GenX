...
class LicenseType(models.Model):
    ...
    id_name = fields.Integer('Class ID')
...
class License(models.Model):
    ...
    license_name = fields.Many2one('hr.licensetype','Class Name')
    name = fields.Char('Doc Abbreviation')
...
class Vessel(models.Model):
    _name = 'hr.vessel'
    _inherit ='hr.abs.parameter'
    company_code = fields.Many2one('hr.companies', 'Company')
    vessel_category = fields.Many2one('hr.vesselcategory','Category')
...
class ShipDepartment(models.Model):
    ...
    ship_dept_code = fields.Char('Code')
...
class CheckList(models.Model):
    _name= 'hr.checklist'
    checklist_code = fields.Char('Code')
    name = fields.Char('Name')
...
class religion(models.Model):
    _name= 'hr.religion'
    religion_code = fields.Char('Code')
    name = fields.Char('Name')
